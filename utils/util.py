...
def load_folds_data(np_data_path, n_folds):
    ...
    files_pairs = [[files[0],files[1],files[2]],[files[3],files[4],files[5]],[files[6],files[7],files[8]],[files[9],files[10],files[11]],[files[12],files[13],files[14]],[files[15],files[16],files[17]]]
    file_pair = []
