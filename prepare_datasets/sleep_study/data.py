...
def init_age_file():
    new_fn = 'age_file.csv'
    age_path = os.path.join('z5298768@kdm.restech.unsw.edu.au','home', 'z5298768', 'Health_Data', ss.info.SLEEP_STUDY)
...
def get_sleep_eeg_and_stages(name, channels=ss.info.EEG_CH_NAMES[6], verbose=False, downsample=True):
